...
<form id="gbcf-form" method="post" action="<?php echo htmlentities($action); ?>#results">
 <fieldset class="main-set"<?php echo $main_border; ?>> 
  <legend class="main-legend"><span<?php echo $main_legnd; ?>><?php echo $main_legend; ?></span></legend>
   <label class="opt-label main-label"><?php echo $main_label;echo'<br><span>'.$required_combo.'</span><br><br>'; ?></label><?php echo $add_break; ?>
<!--required set 1-->
 <fieldset class="req-set"<?php echo $req_border; ?>> 
  <legend class="req-legend"><span<?php echo $sub_legnds; ?>><?php echo $req1_legend; ?></span></legend>
   <label id="name-error" for="name" class="req-label"<?php echo $name_errlbl; ?>><?php echo $required_symbol; echo $name_label; ?></label><?php echo $add_break; ?>
    <input type="text" class="text-med" name="name" value="<?php echo $name_value; ?>" size="32" maxlength="<?php echo $name_len; ?>" id="name"<?php echo $name_border; ?><?php echo $x_or_h; ?>><?php echo $add_break; ?><br>
   <label id="email-error" for="email" class="req-label"<?php echo $email_errlbl; ?>><?php echo $required_symbol; echo $email_label; ?></label><?php echo $add_break; ?>
    <input type="text" class="text-med" name="email" value="<?php echo $email_value; ?>" size="32" maxlength="<?php echo $email_len; ?>" id="email"<?php echo $email_border; ?><?php echo $x_or_h; ?>><?php echo $add_break; ?><br>
...
<?php } ?>
   <label id="subject-error" for="subject" class="req-label"<?php echo $subject_errlbl; ?>><?php echo $required_symbol; echo $subject_label; ?></label><?php echo $add_break; ?>
  ...
  while (list(, $subs) = each($subjects)) {
    ...
    </select><?php echo $add_break; ?><br>
   <label id="message-error" for="message" class="req-label"<?php echo $message_errlbl; ?>><?php echo $required_symbol; echo $message_label; ?></label><?php echo $add_break; ?>
    <textarea class="textarea" rows="12" cols="60" name="message" id="message"<?php echo $message_border; ?>><?php echo $message_value; ?></textarea><?php echo $add_break; ?><br>
   <label id="antispam-error" for="antispam" class="req-label"<?php echo $antispam_errlbl; ?>><?php echo $required_symbol; echo $spam_question; ?></label><?php echo $add_break; ?>
